 ...
 */
public class EnglishEducatonActivity extends BaseActivity
...
*/
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_ENGLISHEDUCATION);
...
//        }
        ...
        menu1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(EnglishEducatonActivity.this, NewNdlmMainActivity.class);
    ...
    private void setupActionBar(String movieTitle) {
        ...
        actionBar.setTitle("Short Movies");
        if (movieTitle != null) {
