 ...
 */
public class SafetyAndSecurityActivity extends BaseActivity
...
*/
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_SAFETYANDSECURITY);
...
//        }
        ...
        menu1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(SafetyAndSecurityActivity.this, Activity1GridView.class);
    ...
    private void setupActionBar(String movieTitle) {
        ...
        actionBar.setTitle("Trip Assistant");
