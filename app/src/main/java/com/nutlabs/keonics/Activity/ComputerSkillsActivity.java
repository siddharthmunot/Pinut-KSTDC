...
/**
 * Created by Shubham on 9/21/2016.
 */
public class ComputerSkillsActivity extends BaseActivity
    ...
    String baseTag;
    Stack<String> genreStack = new Stack<String>();
    @TargetApi(21)
    @Override
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   navigationDrawerFragment = (NavigationDrawerFragment) getSupportFragmentManager()
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_COMPUTERSKILL);
...
//        }
        ...
        menu1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(ComputerSkillsActivity.this, NewNdlmMainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
               /* Intent intent = new Intent(this, Activity1GridView.class);
                ...
                if (genreStack.isEmpty()){
                    ...
                    selectedGenreTitle = genreStack.pop();
                }

                if (selectedMovieId != -1) {
                    selectedMovieId = -1;
                    selectedMovieTitle = null;
                    setupActionBar(selectedGenreTitle);
    ...
    public void onMovieSelected(int movieId, String movieTitle) {
        if (selectedGenreTitle!= null)
            genreStack.push(selectedGenreTitle);
