...
/**
 * Created by Shubham on 10/19/2016.
 */

public class NdlmActivity extends BaseActivity
...
*/
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_NDLM);
...
//        }
        ...
        menu1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(NdlmActivity.this, NewNdlmMainActivity.class);
