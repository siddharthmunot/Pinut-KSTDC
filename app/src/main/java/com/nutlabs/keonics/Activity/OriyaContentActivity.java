 ...
 */
public class OriyaContentActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            args.putString(SharedConstants.MOVIE_TAG, SharedConstants.MOVIE_TAG_ORIYA);
...
//        }
        ...
        menu1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(OriyaContentActivity.this, Activity1GridView.class);
    ...
    private void setupActionBar(String movieTitle) {
        ...
        if (movieTitle != null) {
            ...
            actionBar.setTitle("Oriya Content");
        }
    }
