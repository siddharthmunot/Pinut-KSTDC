...
import com.nutlabs.keonics.kore.jsonrpc.type.FilesType;
import com.nutlabs.keonics.kore.jsonrpc.type.ItemType;
...
public class Files {
    ...
    public static final class GetDirectory extends ApiMethod<List<ListType.ItemFile>> {
         ...
         *                   See {@link com.nutlabs.keonics.kore.jsonrpc.type.ListType.FieldsFiles}
