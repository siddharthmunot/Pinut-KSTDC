...
abstract public class AbstractDetailsFragment extends Fragment
    ...
    /**
     * Should return {@link com.nutlabs.keonics.kore.service.LibrarySyncService} SyncType that
    ...
    /**
     * Should return the {@link com.nutlabs.keonics.kore.service.LibrarySyncService} syncID if this fragment
     * synchronizes a single item. The itemId that should be synced must returned by {@link #getSyncItemID()}
     * @return {@link com.nutlabs.keonics.kore.service.LibrarySyncService} SyncID
     */
